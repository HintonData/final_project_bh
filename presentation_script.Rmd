...
animal_outcomes %>% 
  ...
  filter(region == "QLD" | region == "VIC" | region == "NT") %>% 
  ggplot(aes(x = year, y = total_injuries, color = outcome)) +
...
```
So some interesting things here. The Northern Territory has been fairly stable with low levels of reclaim for decades, and recently has had a huge spike with a massive increase in number of reclaims. Queensland has been steadily climbing, and this speaks well to the RSPCA's efforts. Victoria, has had quite a bit of variability, but as you can see has been on the decline since about 2009. This suggests to me that more initiatives and resources might need to be spent on Victoria.
